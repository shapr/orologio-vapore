  ...
  outputs = {
      ...
      forAllSystems = function:
        nixpkgs.lib.genAttrs [
          ...
          "aarch64-darwin"
            ...
            orologio-vapore = craneLib.buildPackage (craneCommon
              // {
    ...
    in {
      checks = forAllSystems ({
        ...
        inherit orologio-vapore;

        orologio-vapore-clippy = craneLib.cargoClippy (craneCommon
          // {
            inherit cargoArtifacts;
        ...
        # Check formatting
        orologio-vapore-fmt = craneLib.cargoFmt {
          inherit src;
        };

        # Audit dependencies
        orologio-vapore-audit = craneLib.cargoAudit {
      ...
      packages = forAllSystems ({ orologio-vapore, ... }: {
        inherit orologio-vapore;
        default = orologio-vapore;
      });

      apps = forAllSystems ({system, ...}: {
        orologio-vapore = {
          type = "app";
          program = "${self.packages.${system}.orologio-vapore}/bin/orologio-vapore";
        };
        default = self.apps.${system}.orologio-vapore;
      });
